...
#developed in the Python 2.6.3 programming environment
  ...
  def __AdvanceTimePeriod(self):
    ...
    for x in range (0, self.__LandscapeSize):
      for y in range (0, self.__LandscapeSize):
        if not self.__Landscape[x][y].Warren is None:
          if self.__ShowDetail:
            sys.stdout.write("Warren at (" + str(x) + "," + str(y) + "):" + "\n")
            sys.stdout.write("  Period Start: ")
            self.__Landscape[x][y].Warren.Inspect()
    ...
    for x in range (0, self.__LandscapeSize):
      for y in range (0, self.__LandscapeSize):
        if not self.__Landscape[x][y].Fox is None:
          if self.__ShowDetail:
            sys.stdout.write("Fox at (" + str(x) + "," + str(y) + "): " + "\n")
    ...
    for FoxX in range(0, self.__LandscapeSize):
      for FoxY in range (0, self.__LandscapeSize):
        if not self.__Landscape[FoxX][FoxY].Fox is None:
          ...
          if self.__ShowDetail:
            sys.stdout.write("  " + str(FoodConsumed) + " rabbits eaten by fox at (" + str(FoxX) + "," + str(FoxY) + ")."  + "\n")
      ...
      for x in range (0, self.__LandscapeSize):
        if not self.__Landscape[x][y].Warren is None:
          if self.__Landscape[x][y].Warren.GetRabbitCount() < 10:
            sys.stdout.write(" ")
          sys.stdout.write(str(self.__Landscape[x][y].Warren.GetRabbitCount()))
        else:
          sys.stdout.write("  ")
        if not self.__Landscape[x][y].Fox is None:
          sys.stdout.write("F")
...
class Animal(object):
  ...
  def Inspect(self):
    sys.stdout.write("  ID " +  str(self._ID) + " ")
    sys.stdout.write("Age " +  str(self._Age) + " ")
    sys.stdout.write("LS " + str(self._NaturalLifespan) + " ")
    sys.stdout.write("Pr dth " +  str(round(self._ProbabilityOfDeathOtherCauses, 2)) + " ")
...
class Fox(Animal):
  ...
  def Inspect(self):
    ...
    sys.stdout.write("Food needed " + str(self.__FoodUnitsNeeded) + " ")
    sys.stdout.write("Food eaten " +  str(self.__FoodUnitsConsumedThisPeriod) + " ")
    print
...
class Rabbit(Animal):
  ...
  def Inspect(self):
    ...
    sys.stdout.write("Rep rate " + str(round(self.__ReproductionRate, 1)) + " ")
  ...
  while MenuOption != 3:
    ...
    if MenuOption == 1 or MenuOption == 2:
      if MenuOption == 1:
        ...
        LandscapeSize = int(raw_input("Landscape Size: "))
        InitialWarrenCount = int(raw_input("Initial number of warrens: "))
        InitialFoxCount = int(raw_input("Initial number of foxes: "))
        Variability = int(raw_input("Randomness variability (percent): "))
